...
public class TVShow implements Watchable, Bingeable<Episode>,Cloneable {
	...
	//question 2
	File p = new File(" ");
	private Episode aPrototype = new Episode(p,this,"001",1);
	public void setPrototype(Episode pPrototype) {
		aPrototype=pPrototype;
	}
	public Episode createEpisode() throws CloneNotSupportedException {
